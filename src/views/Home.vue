    ...
    <div class="bg-indigo-900 px-4 py-4">
      ...
      >
        ...
        <div class="hidden md:block">
          ...
          <router-link to="/login" class="inline-block py-1 md:py-4 
          text-gray-500 hover:text-gray-100 mr-6">Entrar</router-link>
          
          <a href="#" class="inline-block py-2 px-4 text-gray-700 
          bg-white hover:bg-gray-100 rounded-lg">Registrate</a>
        </div>
      </div>
    </div>
