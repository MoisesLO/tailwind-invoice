    ...
    <div class="bg-indigo-900 px-4 py-4">
      <div class="md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
        ...
        <div class="flex justify-between items-center">
          <a href="#" class="inline-block py-2 text-white text-xl font-bold">Lineysoft.com</a>
        ...
        <div>
          <div class="hidden md:block">
            <a href="#" class="inline-block py-1 md:py-4 text-gray-100 mr-6 font-bold">Como funciona?</a>
            <a href="#" class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-100 mr-6">Precios</a>
            <a href="#" class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-100">Contacto</a>
          </div>
        </div>
        <!-- End Center -->
        ...
        <!-- Right -->
        <div class="hidden md:block">
          <router-link to="/login" class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-100 mr-6">Entrar</router-link>
          <a href="#" class="inline-block py-2 px-4 text-gray-700 bg-white hover:bg-gray-100 rounded-lg">Registrate</a>
        </div>
        <!-- End Right -->
        ...
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              <h1 class="font-bold text-white text-2xl md:text-5xl leading-tight mb-4">Facturacion electronica para tu empresa</h1>
